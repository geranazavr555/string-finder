...
public:
    ...
    bool check(std::unordered_map<QString, Trigrams>::const_iterator index_iter) const;

private:
    static size_t count_trigrams(std::unordered_map<QString, Trigrams>::const_iterator const& index_iter);
